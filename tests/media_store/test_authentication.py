...
class TestAuthenticationLogic:
    ...
    def test_get_current_user_with_write_permission_allows_write_permission(self):
        ...
        with patch("services.media_store.src.auth.AUTH_DISABLED", False):
    ...
    def test_get_current_user_with_write_permission_rejects_none_user(self):
        ...
        from services.media_store.src.auth import get_current_user_with_write_permission, AUTH_DISABLED
        import asyncio
    ...
    def test_get_current_user_with_read_permission_allows_read_permission(self):
        ...
        from services.media_store.src.auth import get_current_user_with_read_permission
...
class TestAuthenticationModes:
    ...
    def test_auth_disabled_flag_defaults_to_false(self):
        ...
        from services.media_store.src.config import AUTH_DISABLED
    ...
    def test_read_auth_enabled_flag_defaults_to_false(self):
        ...
        from services.media_store.src.config import READ_AUTH_ENABLED
        # In test environment without env var, should be False
    ...
    def test_demo_mode_bypasses_read_auth(self):
        ...
        from services.media_store.src.auth import get_current_user_with_read_permission, AUTH_DISABLED
        from services.media_store.src.config_service import ConfigService
        from unittest.mock import MagicMock
        import asyncio
