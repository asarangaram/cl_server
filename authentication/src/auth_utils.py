...
from .config import SECRET_KEY, ALGORITHM, ACCESS_TOKEN_EXPIRE_MINUTES, DATABASE_DIR

# Password hashing
import bcrypt

# Key management
PRIVATE_KEY_PATH = os.path.join(DATABASE_DIR, "private_key.pem")
PUBLIC_KEY_PATH = os.path.join(DATABASE_DIR, "public_key.pem")
